...
complete -c crio -n '__fish_crio_no_subcommand' -f -l default-env -r -d 'additional environment variables to set for all containers (default: [])'
...
complete -c crio -n '__fish_crio_no_subcommand' -f -l root -s r -r -d 'crio root dir (default: "/home/vagrant/.local/share/containers/storage")'
complete -c crio -n '__fish_crio_no_subcommand' -f -l runroot -r -d 'crio state dir (default: "/run/user/1000/containers")'
...
complete -c crio -n '__fish_crio_no_subcommand' -f -l storage-driver -s s -r -d 'storage driver (default: "vfs")'
