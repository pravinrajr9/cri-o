...
complete -c crio -n '__fish_crio_no_subcommand' -f -l apparmor-profile -r -d 'Name of the apparmor profile to be used as the runtime\'s default. The default profile name is \'crio-default-\' followed by the version string of CRI-O. (default: "crio-default-1.17.5")'
...
complete -c crio -n '__fish_crio_no_subcommand' -f -l decryption-secl-parameters -r -d 'Parameters to get keys via ISECL (default: "")'
...
complete -c crio -n '__fish_crio_no_subcommand' -l version-file -r -d 'Location for CRI-O to lay down the temporary version file (default: /var/run/crio/version)'
complete -c crio -n '__fish_crio_no_subcommand' -l version-file-persist -r -d 'Location for CRI-O to lay down the persistent version file (default: /var/lib/crio/version)'
